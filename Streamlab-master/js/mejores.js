                    ...
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="text">
                                ...
                                <button class="primary" data-nombre="${mejor.nombre}" data-descripcion="${mejor.descripcion}" data-duracion="${mejor.duracion}" data-genero="${mejor.genero}" data-imagen="${mejor.imagen}" data-popularidad="${mejor.popularidad}" >Ver Más</button>
                                </div>
                            </div>
                        </div>
                    `;
