                    ...
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="text">
                                ...
                                <button class="primary" data-nombre="${pelicula.nombre}" data-descripcion="${pelicula.descripcion}" data-duracion="${pelicula.duracion}" data-genero="${pelicula.genero}" data-imagen="${pelicula.imagen}">Ver Más</button>
                            </div>
                        </div>
                    </div>
                `;
