                    ...
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="text">
                                ...
                                <button class="primary" data-nombre="${reciente.nombre}" data-descripcion="${reciente.descripcion}" data-duracion="${reciente.duracion}" data-genero="${reciente.genero}" data-imagen="${reciente.imagen}" data-popularidad="${reciente.popularidad}">Ver Más</button>
                                </div>
                            </div>
                        </div>
                    `;
